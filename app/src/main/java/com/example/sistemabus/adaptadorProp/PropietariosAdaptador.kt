...
class PropietariosAdaptador(private val condList: ArrayList<Propietarios>,
                            private val comentClickListener: onClickListener
                         ) : RecyclerView.Adapter<PropietariosAdaptador.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        parent: ViewGroup,
        viewType: Int
    ): PropietariosAdaptador.MyViewHolder {
    ...
    override fun onBindViewHolder(holder: PropietariosAdaptador.MyViewHolder, position: Int) {
        val conductores: Propietarios = condList[position]
